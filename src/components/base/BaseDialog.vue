  ...
  <TransitionRoot as="template" :show="dialogStore.active">
    ...
    >
      ...
      >
        ...
        >
          <div
            class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl  sm:my-8 sm:align-middle sm:w-full sm:p-6"
